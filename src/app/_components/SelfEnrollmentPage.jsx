...
export default function SelfEnrollmentPage({ locale, partner }) {
  const shell = getShellDictionary(locale);

  return (
    <main className="main">
      <div className="page-title self-enrollment-title">
        ...
        <nav className="breadcrumbs">
          <div className="container">
            <ol>
              <li>
                <Link href={localizePath("/", locale)}>{shell.nav.home}</Link>
              </li>
              <li>{shell.nav.selfEnrollment}</li>
            ...
            <div className="col-lg-6">
              <div className="self-enrollment-copy">
                ...
                <div className="self-enrollment-actions">
                  ...
                  {/* <Link href={localizePath("/contact", locale)} className="btn-enrollment-secondary">
                    Talk to H4H
                  </Link> */}
                </div>
              </div>
