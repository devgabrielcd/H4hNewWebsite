...
export default async function ServiceDetailsPage({ params }) {
  ...
  const service = getServiceDetailsDictionary(lang);
          ...
          <div className="row gy-5">
            <div className="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
              <div className="service-image">
                <img src="/assets/img/health/cardiology-3.webp" alt={service.imageAlt} className="img-fluid" />
            ...
            <div className="col-lg-6" data-aos="fade-left" data-aos-delay="300">
              <div className="service-content">
                ...
                <div className="service-actions">
                  ...
                  <a href={localizePath("/services", lang)} className="btn-secondary">{service.actions.secondary}</a>
                </div>
              </div>
            </div>
          </div>
